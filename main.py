...
class InternetSpeedTwitterBot:
    ...
    def get_internet_speed(self):
        ...
        time.sleep(60)
        # Close pop up window
        pop_up_close = self.driver.find_element(By.XPATH, '//*[@id="container"]/div/div[3]/div/div/div/div[2]/div[3]/div[3]/div/div[8]/div/a')
        pop_up_close.click()
    ...
    def tweet_at_provider(self):
        ...
        time.sleep(3)
        sign_in_button = self.driver.find_element(By.XPATH, '//*[@id="react-root"]/div/div/div/main/div/div/div/div[1]/div/div[3]/div[5]/a/div')
        sign_in_button.click()

        time.sleep(3)
        email_address = self.driver.find_element(By.XPATH, '//*[@id="layers"]/div/div/div/div/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div[1]/div/div[5]/label/div/div[2]/div/input')
        email_address.send_keys(TWITTER_EMAIL)
        email_address.send_keys(Keys.ENTER)

        time.sleep(3)
        password = self.driver.find_element(By.XPATH, '//*[@id="layers"]/div/div/div/div/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div[1]/div/div[3]/div/label/div/div[2]/div[1]/input')
